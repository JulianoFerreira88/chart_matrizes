...
public class LineChart extends JPanel {
    ...
    public LineChart() {
        ...
        chart = ChartFactory.createLineChart("", "", "", data);
        setChartColor(Color.darkGray);
        setChartLabelsColor(Color.white);
        setChartLabelsAngleDown_45();
        setChartMarksVisible(true);
        setChartMarksColor(Color.white);
